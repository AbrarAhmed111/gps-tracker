...
const ADMIN_PATHS = ['/admin-panel', '/admin', '/crm']
// Protect admin APIs too; otherwise unauthenticated callers can hit /api/admin/*
...
export async function updateSession(request: NextRequest) {
  ...
  const isAdminApiPath = ADMIN_API_PATHS.some(path =>
    currentPath.startsWith(path),
  )
